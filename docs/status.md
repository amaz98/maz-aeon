...
**Overall:** 🟡 WATCH
**Updated:** 2026-09-26 15:01 UTC
**Open issues:** 1
**Next scheduled run:** heartbeat at 2026-09-26 20:00 UTC
...
|-------|----------|--------|-------------:|---------------------:|
| heartbeat | 2026-09-25 15:32 UTC | ✅ success | 100% | 0 |

## Open issues

| ID | Title | Severity | Category | Detected |
|----|-------|----------|----------|----------|
| [ISS-002](https://github.com/aeonframework/maz-aeon/blob/main/memory/issues/ISS-002.md) | Recurring 08:00 UTC heartbeat dispatch slot skips | critical | permanent-limitation | 2026-09-02 |
